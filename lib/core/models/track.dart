...
import 'package:inmusic/core/models/album.dart';
...
class Track {
  ...
  @override
  String toString() {
    return 'Track(title: $title, videoId: $videoId, description: $description, thumbnails: $thumbnails, artists: $artists, albums: $albums, path: $path, art: $art, colorPalette: $colorPalette)';
  }
